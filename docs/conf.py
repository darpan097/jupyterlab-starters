...
htmlhelp_basename = "jupyterstartersdoc"
...
man_pages = [
    (master_doc, "jupyterstarters", "JupyterStarters Documentation", [author], 1)
]
...
github_repo_name = "jupyter_starters"
